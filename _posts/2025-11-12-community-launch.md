...
*   **Openness and collaboration**: allowing any company or individual to freely access and use the CyberTOMP framework.
*   **Security and trust**: ensuring that when an organization requests a third party to apply the model on its behalf, it is truly CyberTOMP—with its defined characteristics, processes, and procedures—not an altered version misusing the name.
