...
*   Each project repository will contain at least *master*, *next-dev* and *current-dev* branches. The *master* branch will have minimal activity and will primarily represent the latest stable release of the project. The *next-dev* branch will include all new bug fixes and enhancements aimed at the next major version of the **CyberTOMP®** framework. The *current-dev* branch will include bug-fixing and minor changes aimed to release new revisions of the current **CyberTOMP®** framework, major version.
