...
*   Each project repository will contain at least *master*, *dev-next_version* and *dev-current_version* branches (change next_version and current_version by their corresponding number values). The *master* branch will have minimal activity and will primarily represent the latest stable release of the project. The *dev-next_version* branch will include all new bug fixes and enhancements aimed at the next major version of the **CyberTOMP®** framework. The *dev-current_version* branch will include bug-fixing and minor changes aimed to release new revisions of the current **CyberTOMP®** framework, major version.
